    ...
    <div className="space-y-4 text-gray-100">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 text-sm">
          <label className="text-gray-300">Format Indent:</label>
          <select
            value={indent}
            onChange={(e) => setIndent(Number(e.target.value))}
            className="p-1.5 border rounded-lg bg-gray-900 border-gray-700 text-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
