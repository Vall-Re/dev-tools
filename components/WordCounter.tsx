...
export default function WordCounter() {
  ...
  const stats = useMemo(() => {
    ...
    // Орієнтовний час читання (200 слів/хв) та мовлення (130 слів/хв)
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 text-center font-mono text-sm">
        ...
        <div className="p-3 border rounded-lg bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Paragraphs</div>
        </div>
        <div className="p-3 border rounded-lg bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
          <div className="text-xl font-bold text-blue-600 dark:text-blue-400">
            {stats.byteSize}
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Bytes (UTF-8)</div>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700 space-y-2 text-xs font-mono">
          <div className="font-semibold text-sm text-gray-700 dark:text-gray-300 border-b pb-1 dark:border-gray-700">
